...
using bitint_base_t = typename BitIntBaseType<W,isSigned>::type;

template <typename T>
constexpr bool is_signed_bitint = false;

template<unsigned int W>
constexpr bool is_signed_bitint<_ExtInt(W)> = true;

template<typename T>
constexpr bool is_unsigned_bitint = false;
